...
import { homePageMetadata } from "@/lib/metadata/en/homepage";
      ...
      <APropos
        ...
        text={
          <>
            ...
            , introduced to web development through the &quot;La Toile&quot;
            training at{" "}
            <span className="text-lightBrown dark:text-darkYellow">
              Emlyon business school
            </span>{" "}
            4th best French business school. Self-taught by following numerous
            tutorials on the internet, I was able to carry out numerous personal
            projects and also by starting{" "}
            <span className="text-lightBrown dark:text-darkYellow">
